...
<div class="pagination">
	...
	<tr class="employeetHeader">
		...
		<th width="120">Leave Name</th>
			<th width="60">Available Leaves</th>
	...
	<c:forEach items="${history}" var="history">
		...
		<td  width="80">${history.getId()}</td>
			<td  width="80">${history.empId}</td>
				...
				<td width="120">${history.avilableLeaves}</td>			
				<td>
				<c:if test="${history.leave_status eq 'Pending'}">
				
				
				<form:form action="${pageContext.request.contextPath}/Admin/leaveHistoryStatus/${history.getId()}/${history.empId}/ById/"  modelAttribute="employeeLeave">
